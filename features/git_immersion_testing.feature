Feature: Testing instructor created homeworks
  ...
  Examples:
    ...
    | non-forked, 10 commits  | solutions/jhasson84.txt | autograder/mvp_spec.rb | Score out of 100: 95 | jhasson84       |
    | non-forked, 2 commits   | solutions/tansaku.txt   | autograder/mvp_spec.rb | Score out of 100: 70 | tansaku         |
    | forked, 10 commits      | solutions/apelade.txt   | autograder/mvp_spec.rb | Score out of 100: 45 | apelade         |
